...
const projects = [
  ...
  },
  {
    emoji: '🌡️',
    title: 'Station Météo',
    description: 'Mesure température, humidité, pression et UV. Affiche tout sur un écran TFT couleur et enregistre les données sur carte SD avec horodatage précis.',
    level: 'Débutant',
  ...
  },
  {
    ...
    description: 'Construis un robot autonome avec un châssis imprimé en 3D qui suit une ligne noire sur le sol grâce à des capteurs infrarouges. Introduction à la robotique et au contrôle PID.',
    level: 'Intermédiaire',
    levelClass: 'badge-intermediaire',
    duration: '5–6 heures',
    link: '/docs/projet-robot/introduction',
    color: '#C45A00',
  },
  {
    emoji: '🔐',
    title: 'Serrure Intelligente',
    description: 'Système de contrôle d\'accès avec lecteur RFID, clavier à codes PIN, afficheur LCD, servo-moteur et alarme. Mémorise les cartes autorisées dans l\'EEPROM.',
    level: 'Intermédiaire',
    levelClass: 'badge-intermediaire',
    duration: '4–5 heures',
    link: '/docs/projet-serrure/introduction',
    color: '#5B2D8E',
  },
  {
    emoji: '⚡',
    title: 'Monitor Solaire',
    description: 'Mesure en temps réel la tension, le courant et la puissance d\'un panneau solaire. L\'Algérie a l\'un des meilleurs gisements solaires au monde — mesure-le toi-même !',
    level: 'Avancé',
    levelClass: 'badge-avance',
    duration: '5–7 heures',
    link: '/docs/projet-solaire/introduction',
    color: '#B8860B',
  },
  {
    emoji: '🎵',
    title: 'Instrument MIDI',
    description: 'Construis un instrument électronique avec des touches capacitives, un amplificateur audio et des LEDs colorées. Joue tes propres mélodies et connecte-le à GarageBand via USB !',
    level: 'Débutant',
    levelClass: 'badge-debutant',
    duration: '3–4 heures',
    link: '/docs/projet-instrument/introduction',
    color: '#8B1A1A',
  },
  {
    emoji: '🌍',
    title: 'Qualité de l\'Air',
    description: 'Mesure CO₂, particules fines et gaz nocifs dans ta salle de classe. Une alerte visuelle et sonore se déclenche quand il faut aérer — un projet avec un vrai impact sur la santé !',
    level: 'Intermédiaire',
    levelClass: 'badge-intermediaire',
    duration: '4–5 heures',
    link: '/docs/projet-air/introduction',
    color: '#2E6B2E',
  },
  {
    emoji: '🧮',
    title: 'Calculatrice RPN',
    description: 'Construis une vraie calculatrice scientifique avec clavier matriciel, écran OLED et boîtier imprimé en 3D. Implémente la notation polonaise inversée (RPN) comme les calculatrices HP professionnelles !',
    level: 'Intermédiaire',
    levelClass: 'badge-intermediaire',
    duration: '4–6 heures',
    link: '/docs/projet-calculatrice/introduction',
    color: '#4A235A',
  },
  {
    emoji: '🛸',
    title: 'CanSat — Mini-Satellite',
    description: 'Construis un satellite miniaturisé qui tient dans une canette ! Lancé par une fusée modèle réduit, il descend avec un parachute cousu à la main et transmet des données GPS et météo en temps réel.',
    level: 'Avancé',
    levelClass: 'badge-avance',
    duration: '15–20 heures',
    link: '/docs/projet-cansat/introduction',
    color: '#1A3A5C',
  },
  {
    emoji: '✈️',
    title: 'Stabilisation Active (PID)',
    description: 'Maîtrise le contrôleur PID — l\'algorithme le plus utilisé en ingénierie. Commence par équilibrer une bille sur un plateau, puis applique le même principe à un drone ou une fusée stabilisée.',
    level: 'Avancé',
    levelClass: 'badge-avance',
    duration: '10–15 heures',
    link: '/docs/projet-stabilisation/introduction',
    color: '#1B4F72',
  },
  {
    emoji: '🗺️',
    title: 'GPS Tracker',
    description: 'Construis un traceur GPS portable qui enregistre tes déplacements en format GPX. Visualise ta trajectoire sur Google Earth après la balade, avec vitesse, altitude et waypoints !',
    level: 'Intermédiaire',
    levelClass: 'badge-intermediaire',
    duration: '5–7 heures',
    link: '/docs/projet-gps-tracker/introduction',
    color: '#1E8449',
  },
  {
    emoji: '🦾',
    title: 'Bras Robotique 4 axes',
    description: 'Construis un bras robotique articulé avec 4 servos, imprimé entièrement en 3D. Programme des mouvements précis, enregistre des séquences et rejoue-les automatiquement.',
    level: 'Avancé',
    levelClass: 'badge-avance',
  ...
  },
  {
    ...
    description: 'Crée un réseau de communication longue portée (jusqu\'à 5km !) entre plusieurs modules Arduino. Collecte des données environnementales depuis différents points de l\'école ou du quartier.',
    level: 'Avancé',
    levelClass: 'badge-avance',
    duration: '6–8 heures',
    link: '#',
...
function StatsSection() {
  const stats = [
    { value: '12', label: 'Projets disponibles' },
